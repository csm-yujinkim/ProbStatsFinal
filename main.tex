...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            Then, $X \sim \mathrm{Bin}(100, 0.05)$.
            \[
                P(X = 5) = {100 \choose 5} \times (0.05)^5 \times (1-0.05)^{100 - 5} = 0.18
            \]
            \item
            $X \sim \mathrm{Bin}(500, 0.05)$.
            So, $\mu_X = 500\times 0.05 = 25$.
            25 defects are expected to be seen.
        \end{enumerate}
        \item
        \begin{enumerate}
            \item
